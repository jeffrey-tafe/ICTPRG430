...
public class UnitTest {
  ...
  public static void main(String[] args) {
    ...
    // Test equals method
    System.out.println("\nTesting Equals override method");
    Unit unit3 = new Unit();
    Unit unit4 = new Unit();
    System.out.println("unit 1 = unit3 (except false): " + unit1.equals(unit3));
    System.out.println("unit 4 = unit3 (except true): " + unit4.equals(unit3));
